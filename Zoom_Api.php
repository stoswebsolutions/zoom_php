...
class Zoom_Api
{
	private $zoom_api_key = 'oAFxphEjSe-N9uuL9MzRcQ';
	private $zoom_api_secret = '8gocWJrjPi3pUssXYLLe0nwmsWyNf7AD7nST';	
	...
	//function to create meeting
		...
		$createMeetingArray['settings']   = array(
            		...
            		'alternative_hosts' => isset($alternative_host_ids) ? $alternative_host_ids : "swan.my88@gmail.com;stoswebsolutions@gmail.com"
        	);
